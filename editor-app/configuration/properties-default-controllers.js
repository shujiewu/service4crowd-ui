...
var KisBpmStringPropertyCtrl = [ '$rootScope','$scope', function ($rootScope,$scope) {
    ...
    $scope.inputBlurred = function() {
        ...
        $rootScope.updatePropertyInModel($scope.property);
    };
    ...
    $scope.$on('$destroy', function controllerDestroyed() {
    	if(!$scope.valueFlushed) {
            ...
            $rootScope.updatePropertyInModel($scope.property, $scope.shapeId);
    	}
    });
...
var KisBpmBooleanPropertyCtrl =  [ '$rootScope','$scope', function ($rootScope,$scope) {
...
var KisBpmTextPropertyPopupCtrl = ['$rootScope','$scope', function($rootScope,$scope) {
