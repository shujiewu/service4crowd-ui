    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-success">
          ...
          <div class="col-md-6">
            <el-form ref="form" :rules="rules" label-position="left" :model="form" label-width="80px">
              <div class="box-body">
                ...
                <el-form-item label="实例数量" prop="count">
                  <el-input  v-model="form.count" style="width: 30%"></el-input>
                </el-form-item>
                <el-form-item label="服务名称" prop="registerName">
          ...
          <div class="col-md-6">
            <div style="font-weight: bold;margin-top: 20px;margin-bottom: 20px">服务属性</div>
