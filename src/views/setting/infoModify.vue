          ...
          <div class="pwdarea">
            ...
            <el-form class="form" :model="pwdForm" :rules="pwdRules" ref="pwdForm" label-width="100px">
              <el-form-item label="原密码" prop="password">
                <el-input type="password" v-model="pwdForm.password" auto-complete="off" size="small"
                          placeholder="请输入原密码"></el-input>
              </el-form-item>
              <el-form-item label="新密码" prop="newpassword">
                <el-input type="password" v-model="pwdForm.newpassword" auto-complete="off" size="small"
                          placeholder="请输入新密码"></el-input>
              </el-form-item>
              <el-form-item label="确认新密码" prop="surepassword">
                <el-input type="password" v-model="pwdForm.surepassword" auto-complete="off" size="small"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      showUsername() {
        const userinfo = 'user' // mutils.getStore('userinfo')
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            if (formName == 'pwdForm') {
              ...
              for (const key in this.phoneForm) {
            ...
            // 保存修改的相关信息
            const userinfo = this.infoForm
            const phoneinfo = this.phoneForm
            const userData = Object.assign(userinfo, phoneinfo)
