...
<template>
  <uploader ref="uploader" :options="options" class="uploader-example" :autoStart="false"  @file-success="fileSuccess" @complete="complete">
    ...
    <uploader-drop>
      ...
      <uploader-btn>select zip/rar file</uploader-btn>
    </uploader-drop>
  ...
  export default {
    data() {
      return {
        options: {
          ...
          target: '//192.168.3.216:9529/api/data/createService', // ?token=' + getToken(),
    ...
    methods: {
      ...
      fileSuccess(rootFile, file, message, chunk) {
        ...
        this.$emit('fileUploadComplete', { serviceEntity: message.serviceEntity })
      },
      start() {
