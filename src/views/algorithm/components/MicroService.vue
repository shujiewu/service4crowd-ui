<template>
  <div class="app-container calendar-list-container" style="padding: 5px; ">
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" size='small' element-loading-text="给我一点时间" border fit
      ...
      <el-table-column align="center" :label="$t('table.serviceId')">
      ...
      <el-table-column align="center" :label="$t('table.groups')">
        <template slot-scope="scope">
      ...
      <el-table-column min-width="100px" align="center" :label="$t('table.actions')"
        ...
        <template slot-scope="scope">
          <el-button-group v-if="scope.row.userId!='All'">
            ...
            <router-link :to="{path:'/service/JSONEditor'}">
    ...
    <el-dialog title="New Method" :visible.sync="dialogFormVisible" width="800px">
      ...
      <div class="callout">
        <h4>MicroService Description Example</h4>
        {
        <br/>&nbsp;&nbsp;&nbsp;&nbsp;"ServiceId": "AggregateResult",
        <br/>&nbsp;&nbsp;&nbsp;&nbsp;"Type": "ServiceTask",
        <br/>&nbsp;&nbsp;&nbsp;&nbsp;"Description": "结果汇聚",
        <br/>&nbsp;&nbsp;&nbsp;&nbsp;"Permission": "All",
        <br/>&nbsp;&nbsp;&nbsp;&nbsp;"Group": "结果",
        ...
        <br/>&nbsp;&nbsp;&nbsp;&nbsp;"value":"",
        <br/>&nbsp;&nbsp;&nbsp;&nbsp;"type":"string",
        <br/>&nbsp;&nbsp;&nbsp;&nbsp;"description":"Input Data Type",
        <br/>&nbsp;&nbsp;&nbsp;&nbsp;"scope":"execution"
        <br/>&nbsp;&nbsp;&nbsp;&nbsp;},{
        <br/>&nbsp;&nbsp;&nbsp;&nbsp;"name":"dataId",
        <br/>&nbsp;&nbsp;&nbsp;&nbsp;"value":"",
        <br/>&nbsp;&nbsp;&nbsp;&nbsp;"type":"string",
        <br/>&nbsp;&nbsp;&nbsp;&nbsp;"description":"Input Data Id",
        <br/>&nbsp;&nbsp;&nbsp;&nbsp;"scope":"execution"
        <br/>&nbsp;&nbsp;&nbsp;&nbsp;}],
        <br/>&nbsp;&nbsp;&nbsp;&nbsp;"OutputParameters": [{
        <br/>&nbsp;&nbsp;&nbsp;&nbsp;"name":"AggregateResultId",
        <br/>&nbsp;&nbsp;&nbsp;&nbsp;"value":"",
        <br/>&nbsp;&nbsp;&nbsp;&nbsp;"type":"string",
        <br/>&nbsp;&nbsp;&nbsp;&nbsp;"description":"Aggregate Result Id",
        <br/>&nbsp;&nbsp;&nbsp;&nbsp;"scope":"execution"
        <br/>&nbsp;&nbsp;&nbsp;&nbsp;}
        <br/>&nbsp;&nbsp;]
        <br/>}
...
<script>
  import { fetchList,deleteService } from '@/api/data/microservice'
  ...
  export default {
    ...
    methods: {
      ...
      fileUploadCompleteHandler(val) {
        this.dialogFormVisible = false
        this.list.unshift(val.serviceEntity)
      },
