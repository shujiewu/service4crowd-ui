<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row
      ...
      <el-table-column  align="center" :label="$t('table.version')">
        <template slot-scope="scope">
      ...
      <el-table-column min-width="200px" align="center" :label="$t('table.deploymentTime')">
        <template slot-scope="scope">
          <span>{{scope.row.deploymentTime | parseTime('{y}-{m}-{d} {h}:{i}')}}</span>
        </template>
      </el-table-column>
...
<script>
import { fetchProcess, fetchPv, createModel, deleteDeploy, readResource, startProcess } from '@/api/process/index'
